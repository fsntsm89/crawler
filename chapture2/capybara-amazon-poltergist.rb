...
module Crawler
  class Amazon
    ...
    def portal
      wait_for_ajax
      # IDが複数ないためコメントアウト
      #      select('AMAZON_AFFILIATE_ID', :from => 'idbox_store_id')
      ...
      wait_for_ajax
      page.save_screenshot('../screenshot/screenshot2.png', :full => true)
      first('.line-item-links')
        .click_link("レポート全体を表示")
    end

    def report
      page.save_screenshot('../screenshot/screenshot3.png', :full => true)
